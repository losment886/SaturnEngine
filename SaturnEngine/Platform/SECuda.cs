...
namespace SaturnEngine.Platform
{
    public class SECuda
    {
        ...
        {
            [DllImport("SaturnEngineCuda.dll")]
            public static extern void* CudaALU1D();
    ...
    , cudaErrorApiFailureBase = 10000
        ...
        {
            char[] name = new char[256];                  /**< ASCII string identifying device */
            CUuuid_st uuid;                       /**< 16-byte unique identifier */
            char[] luid = new char[8];                    /**< 8-byte locally unique identifier. Value is undefined on TCC and non-Windows platforms */
            uint luidDeviceNodeMask;         /**< LUID device node mask. V2 is undefined on TCC and non-Windows platforms */
